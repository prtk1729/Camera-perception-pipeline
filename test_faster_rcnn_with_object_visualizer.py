...
object_detector = ObjectDetector(object_detector_type= ObjectDetectorType.Faster_RCNN_ResNet50, threshold=0.7)
vis = Visualizer()
...
for index, image_path in enumerate(all_camera_images_paths):
    ...
    vis.draw_objects_on_image(img, objects,False, 50)
